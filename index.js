...
function inicializarElementos() {
    ...
    btnCerrarClose = document.getElementById("btnCerrarClose");
...
function inicializarEventos() {
    ...
    btnCerrarClose.onclick = cerrarModalCotizarProducto;

    for (const boton of btnCerrarClose) {
